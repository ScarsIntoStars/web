...
<div class="row">
	...
	<div class="input-group mb-3">
		...
		<div class="input-group mb-3">
			...
			<input name="year" type="radio" value="1" class="px-2" <c:out value="${vo.year==1? 'checked' : '' }"/>>
			<span class="p-2">1학년</span>
			<input name="year" type="radio" value="2" class="px-2" <c:out value="${vo.year==2? 'checked' : '' }"/>>
			<span class="p-2">2학년</span>
			<input name="year" type="radio" value="3" class="px-2" <c:out value="${vo.year==3? 'checked' : '' }"/>>
			<span class="p-2">3학년</span>
			<input name="year" type="radio" value="3" class="px-2" <c:out value="${vo.year==4? 'checked' : '' }"/>>
