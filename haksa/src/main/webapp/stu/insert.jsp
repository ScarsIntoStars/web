...
<form name="frm1" method="post" action="/stu/insert">
	...
	<div class="input-group mb-2">
		...
		<select name="dept" class="form-select">
			...
			<option value="전자" selected>전자공학</option>
	...
	<div class="input-group mb-3">
		...
		<input name="year" type="radio" value="1" class="px-2" checked>
		<span class="p-2">1학년</span>
		<input name="year" type="radio" value="2" class="px-2">
		<span class="p-2">2학년</span>
		<input name="year" type="radio" value="3" class="px-2">
